 ...
 * Constraints:
 * 
 * 1 <= words.length <= 1000 1 <= words[i].length, chars.length <= 100 words[i]
 * and chars consist of lowercase English letters.
 **/
public class Program1 {
	...
	public static void main(String[] args) {
		...
		int result = solution1.countCharacters(words, chars);
